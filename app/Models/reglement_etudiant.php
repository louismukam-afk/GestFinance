...
class reglement_etudiant extends Model
{
    use HasFactory;

    protected $table='reglement_etudiants';
    public $timestamps=true;

    protected  $fillable = [
        'id_cycle', 'id_niveau', 'id_caisse',
        'id_banque', 'id_filiere', 'id_scolarite',
        'id_frais', 'id_tranche_scolarite',
        'id_specialite', 'id_etudiant', 'id_budget',
    ...
    public function entite(){
        return $this->belongsTo(entite::class,'id_entite')->withDefault([
            'logo' => 'uploads/images/1759420569_logo.jpg',
            'nom_entite' => '—',
            'telephone' => '—'
        ]);
    }
